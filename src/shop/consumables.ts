...
export const CONSUMABLE_DEFS: ConsumableDef[] = [
  {
    ...
    cost: '1250', currency: 'gold', durationMs: 60000, buffId: 'click_x2', buffMult: 2, instant: 'box', unlockLevel: 3,
  },
  {
    id: 'prod_potion', name: 'Poção de Produção', icon: '⚗️',
    desc: 'Dobra a produção de energia por 5 minutos.',
    cost: '6250', currency: 'gold', durationMs: 300000, buffId: 'prod_x2', buffMult: 2, instant: 'box', unlockLevel: 5,
  },
  {
    id: 'gold_potion', name: 'Poção de Ouro', icon: '🫙',
    desc: 'Dobra o ganho de ouro por 5 minutos.',
    cost: '6250', currency: 'gold', durationMs: 300000, buffId: 'gold_x2', buffMult: 2, instant: 'box', unlockLevel: 6,
  },
  {
    id: 'luck_elixir', name: 'Elixir da Sorte', icon: '🍀',
    desc: '+25% de chance crítica por 2 minutos.',
    cost: '12500', currency: 'gold', durationMs: 120000, buffId: 'crit_boost', buffMult: 1, instant: 'box', unlockLevel: 8,
  },
  {
    id: 'gold_chest', name: 'Baú de Ouro', icon: '📦',
    desc: 'Concede ouro equivalente a 1 hora de produção.',
    cost: '25000', currency: 'gold', durationMs: 0, instant: 'gold', instantAmountHours: 1, unlockLevel: 10,
  },
  {
    id: 'energy_cell', name: 'Bateria de Emergência', icon: '🔋',
    desc: 'Concede energia equivalente a 30 minutos de produção.',
    cost: '18750', currency: 'gold', durationMs: 0, instant: 'energy', instantAmountHours: 0.5, unlockLevel: 12,
  },
  {
    id: 'pet_food', name: 'Ração Mágica', icon: '🍖',
    desc: 'Dá XP ao primeiro pet equipado.',
    cost: '3750', currency: 'gold', durationMs: 0, instant: 'petxp', instantAmountHours: 0, unlockLevel: 7,
  },
  {
    id: 'box_ticket', name: 'Ticket de Caixa', icon: '🎫',
    desc: 'Concede uma Caixa Básica.',
    cost: '5000', currency: 'gold', durationMs: 0, instant: 'box', instantAmountHours: 0, unlockLevel: 9,
  },
  ...
  // ── Premium (custam Diamantes 💎 — moeda paga) ──────────
  {
    ...
    cost: '400', currency: 'crystals', creditCost: 150, durationMs: 600000, buffId: 'click_x2', buffMult: 3, instant: 'box', unlockLevel: 15,
  },
  {
    id: 'diamond_prod', name: 'Reator Portátil', icon: '🟣',
    desc: 'Triplica a produção de energia por 15 minutos.',
    cost: '600', currency: 'crystals', creditCost: 200, durationMs: 900000, buffId: 'prod_x2', buffMult: 3, instant: 'box', unlockLevel: 20,
  },
  {
    id: 'diamond_gold', name: 'Manancial de Ouro', icon: '👑',
    desc: 'Triplica o ganho de moedas por 15 minutos.',
    cost: '600', currency: 'crystals', creditCost: 200, durationMs: 900000, buffId: 'gold_x2', buffMult: 3, instant: 'box', unlockLevel: 20,
  },
];
