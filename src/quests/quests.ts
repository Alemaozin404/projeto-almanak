...
export const QUEST_DEFS: QuestDef[] = [
  // ── Permanentes ─────────────────────────────────────────
  { id: 'q_p1', name: 'Aquecendo', icon: '🖱️', desc: 'Clique 250 vezes.', source: 'clicks', target: '250', reward: r('1000', '50'), category: 'permanente' },
  { id: 'q_p2', name: 'Clicador', icon: '👆', desc: 'Clique 12.000 vezes.', source: 'clicks', target: '12000', reward: r('25000', '400'), category: 'permanente' },
  { id: 'q_p3', name: 'Máquina de Cliques', icon: '⚙️', desc: 'Clique 250.000 vezes.', source: 'clicks', target: '250000', reward: r('1000000', '2500'), category: 'permanente' },
  { id: 'q_p4', name: 'Implacável', icon: '🔥', desc: 'Clique 25 milhões de vezes.', source: 'clicks', target: '25000000', reward: r('50020000', '15000'), category: 'permanente' },
  ...
  { id: 'q_p6', name: 'Coletor de Energia', icon: '⚡', desc: 'Produza 2,5 milhões de energia (total).', source: 'energyProduced', target: '2500000', reward: r('100000', '1500'), category: 'permanente' },
  { id: 'q_p7', name: 'Usina Viva', icon: '🏭', desc: 'Produza 2,5 bilhões de energia (total).', source: 'energyProduced', target: '2500000000', reward: r('50010000', '10000'), category: 'permanente' },
  { id: 'q_p8', name: 'Força Cósmica', icon: '🌌', desc: 'Produza 2,5e15 de energia (total).', source: 'energyProduced', target: '2.5e15', reward: r('1000000050000', '50000'), category: 'permanente' },
  { id: 'q_p9', name: 'Primeiro Ouro', icon: '🪙', desc: 'Acumule 6.000 de ouro ganho.', source: 'goldEarned', target: '6000', reward: r('10000', '250'), category: 'permanente' },
  { id: 'q_p10', name: 'Magnata', icon: '💰', desc: 'Acumule 60 milhões de ouro ganho.', source: 'goldEarned', target: '60000000', reward: r('50010000', '5000'), category: 'permanente' },
  ...
  { id: 'q_p26', name: 'Equilibrista', icon: '⚖️', desc: 'Alcance a energia atual de 2,5 milhões.', source: 'energyNow', target: '2500000', reward: r('200000', '2500'), category: 'permanente' },
  { id: 'q_p27', name: 'Barão do Ouro', icon: '🏦', desc: 'Alcance 6 milhões de ouro atuais.', source: 'goldNow', target: '6000000', reward: r('2000000', '5000'), category: 'permanente' },
  { id: 'q_p28', name: 'Rico', icon: '💵', desc: 'Tenha 600 bilhões de ouro acumulado.', source: 'goldEarned', target: '600000000000', reward: r('100000020000', '50000'), category: 'permanente' },
  ...
  // ── Diárias ─────────────────────────────────────────────
  { id: 'q_d1', name: 'Cliques do Dia', icon: '🖱️', desc: 'Clique 1.000 vezes hoje.', source: 'clicks', target: '1000', reward: r('26000', '500'), category: 'diaria' },
  { id: 'q_d2', name: 'Cliques do Dia II', icon: '👆', desc: 'Clique 4.000 vezes hoje.', source: 'clicks', target: '4000', reward: r('102000', '1250'), category: 'diaria' },
  { id: 'q_d3', name: 'Energia Diária', icon: '⚡', desc: 'Produza 2 milhões de energia hoje.', source: 'energyProduced', target: '2000000', reward: r('100000', '1000'), category: 'diaria' },
  { id: 'q_d4', name: 'Energia Diária II', icon: '🔋', desc: 'Produza 2 bilhões de energia hoje.', source: 'energyProduced', target: '2000000000', reward: r('50003000', '5000'), category: 'diaria' },
  { id: 'q_d5', name: 'Ouro do Dia', icon: '🪙', desc: 'Ganhe 25.000 de ouro hoje.', source: 'goldEarned', target: '25000', reward: r('50000', '750'), category: 'diaria' },
  { id: 'q_d6', name: 'Ouro do Dia II', icon: '💰', desc: 'Ganhe 2,5 milhões de ouro hoje.', source: 'goldEarned', target: '2500000', reward: r('2502000', '3000'), category: 'diaria' },
  ...
  // ── Semanais ────────────────────────────────────────────
  { id: 'q_w1', name: 'Semana de Cliques', icon: '🖱️', desc: 'Clique 100.000 vezes na semana.', source: 'clicks', target: '100000', reward: r('2505000', '7500'), category: 'semanal' },
  { id: 'q_w2', name: 'Semana de Energia', icon: '⚡', desc: 'Produza 2e12 de energia na semana.', source: 'energyProduced', target: '2e12', reward: r('100000010000', '25000'), category: 'semanal' },
  { id: 'q_w3', name: 'Semana de Ouro', icon: '🪙', desc: 'Ganhe 500 milhões de ouro na semana.', source: 'goldEarned', target: '500000000', reward: r('500005000', '12500'), category: 'semanal' },
  { id: 'q_w4', name: 'Semana de Caixas', icon: '📦', desc: 'Abra 150 caixas na semana.', source: 'boxesOpened', target: '150', reward: r('1000000', '5000', { boxes: { rare: 1 } }), category: 'semanal' },
  ...
  { id: 'q_w6', name: 'Semana de Prestígio', icon: '🌀', desc: 'Faça 3 prestígios na semana.', source: 'prestigeCount', target: '3', reward: r('10000000', '20000', { prestigeCoins: '5' }), category: 'semanal' },
  { id: 'q_w7', name: 'Semana de Conquistas', icon: '🏆', desc: 'Desbloqueie 15 conquistas na semana.', source: 'achievements', target: '15', reward: r('5005000', '10000'), category: 'semanal' },
];
