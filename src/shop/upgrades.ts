...
const TEMPLATES: Template[] = [
  // ── Clique ─────────────────────────────────────────────
  {
    ...
    baseCost: 125, currency: 'energy', costMult: 1.17, maxLevel: 200, unlockLevel: 1, rarity: 'common', tiers: 6,
  ...
  },
  {
    ...
    baseCost: 6250, currency: 'energy', costMult: 1.2, maxLevel: 200, unlockLevel: 8, rarity: 'uncommon', tiers: 5,
  ...
  },
  {
    ...
    baseCost: 250000, currency: 'energy', costMult: 1.22, maxLevel: 200, unlockLevel: 18, rarity: 'rare', tiers: 4,
  ...
  },
  {
    ...
    baseCost: 750, currency: 'energy', costMult: 1.27, maxLevel: 50, unlockLevel: 5, rarity: 'uncommon', tiers: 5,
  ...
  },
  {
    ...
    baseCost: 1500, currency: 'energy', costMult: 1.24, maxLevel: 100, unlockLevel: 6, rarity: 'rare', tiers: 4,
  ...
  },
  {
    ...
    baseCost: 125000, currency: 'energy', costMult: 1.32, maxLevel: 30, unlockLevel: 22, rarity: 'epic', tiers: 3,
  ...
  },
  {
    ...
    baseCost: 12500000, currency: 'energy', costMult: 1.37, maxLevel: 25, unlockLevel: 40, rarity: 'legendary', tiers: 3,
  ...
  },
  {
    ...
    baseCost: 2000, currency: 'energy', costMult: 1.22, maxLevel: 100, unlockLevel: 5, rarity: 'uncommon', tiers: 4,
  ...
  },
  {
    ...
    baseCost: 50000, currency: 'energy', costMult: 1.27, maxLevel: 100, unlockLevel: 15, rarity: 'rare', tiers: 4,
  ...
  // ── Produção ────────────────────────────────────────────
  {
    ...
    baseCost: 625, currency: 'gold', costMult: 1.22, maxLevel: 300, unlockLevel: 3, rarity: 'common', tiers: 6,
  ...
  },
  {
    ...
    baseCost: 50000, currency: 'gold', costMult: 1.27, maxLevel: 250, unlockLevel: 12, rarity: 'uncommon', tiers: 5,
  ...
  },
  {
    ...
    baseCost: 12500, currency: 'gold', costMult: 1.24, maxLevel: 200, unlockLevel: 10, rarity: 'rare', tiers: 4,
  ...
  },
  {
    ...
    baseCost: 250000, currency: 'gold', costMult: 1.3, maxLevel: 100, unlockLevel: 28, rarity: 'epic', tiers: 3,
  ...
  // ── Economia ────────────────────────────────────────────
  {
    ...
    baseCost: 1000, currency: 'gold', costMult: 1.22, maxLevel: 200, unlockLevel: 5, rarity: 'common', tiers: 6,
  ...
  },
  {
    ...
    baseCost: 3750, currency: 'gold', costMult: 1.27, maxLevel: 50, unlockLevel: 9, rarity: 'uncommon', tiers: 4,
  ...
  },
  {
    ...
    baseCost: 12500, currency: 'gold', costMult: 1.32, maxLevel: 50, unlockLevel: 10, rarity: 'rare', tiers: 4,
  ...
  },
  {
    ...
    baseCost: 125000, currency: 'gold', costMult: 1.32, maxLevel: 50, unlockLevel: 20, rarity: 'epic', tiers: 3,
  ...
  // ── Prestígio ───────────────────────────────────────────
  {
    ...
    baseCost: 250, currency: 'prestigeCoins', costMult: 1.37, maxLevel: 100, unlockLevel: 1, rarity: 'legendary', tiers: 4,
  ...
  },
  {
    ...
    baseCost: 625, currency: 'prestigeCoins', costMult: 1.42, maxLevel: 100, unlockLevel: 1, rarity: 'mythic', tiers: 4,
  ...
  },
  {
    ...
    baseCost: 12, currency: 'ascensionCoins', costMult: 1.52, maxLevel: 100, unlockLevel: 1, rarity: 'divine', tiers: 3,
